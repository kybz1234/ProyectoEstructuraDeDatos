...
public class Arbol {
    ...
    public String pasaraArbol(ListaCircularSimple lista, NodoArbol subRaíz, NodoArbol nuevoNodo) {
if (subRaíz != null) {
            return pasaraArbol(lista,subRaíz.izquierdo, nuevoNodo)
                    + subRaíz.dato + ", "
                    + pasaraArbol(lista, subRaíz.derecho, nuevoNodo);
        }
        return "";
}
}
